...
<script>
  ...
  export default {
    name: 'Game',
    mounted() {
      this.game = new Runner("#game-wrapper");
    },
    destroyed() {
      this.game = null;
    }
